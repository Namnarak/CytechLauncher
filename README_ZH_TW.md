...
我們正在使用 Weblate 平台翻譯 Cytech Launcher，歡迎您前往我們的 [Weblate 專案](https://hosted.weblate.org/projects/cytechlauncher2) 參與翻譯！  
感謝每一位語言貢獻者的支持，讓 Cytech Launcher 更加多語化、更加國際化！
...
1. 當你分發本程式的修改版本時，必須以合理方式修改該程式的名稱或版本號，以區別於原始版本。（依據 [GPLv3, 7(c)](https://github.com/CytechLauncher/CytechLauncher2/blob/969827b/LICENSE#L372-L374)）
    - 修改版本 **不得在名稱中包含原程式名稱「CytechLauncher」或其縮寫「ZL」，亦不得使用與官方名稱相近、可能造成混淆的名稱**。
    - 所有修改版本 **必須在程式啟動畫面或主介面中以明顯方式標示其為「非官方修改版」**。
    - 程式的應用名稱可於 [gradle.properties](./CytechLauncher/gradle.properties) 中進行修改。

2. 你不得移除本程式所顯示的版權聲明。（依據 [GPLv3, 7(b)](https://github.com/CytechLauncher/CytechLauncher2/blob/969827b/LICENSE#L368-L370)）
