...
val cytechPackageName = "com.movtery.cytechlauncher"
...
val generatedCytechDir = file("$buildDir/generated/source/cytech/java")
...
configure<com.github.megatronking.stringfog.plugin.StringFogExtension> {
    ...
    fogPackages = arrayOf("$cytechPackageName.info")
    kg = com.github.megatronking.stringfog.plugin.kg.RandomKeyGenerator()
    mode = com.github.megatronking.stringfog.plugin.StringFogMode.bytes
}

android {
    namespace = cytechPackageName
    compileSdk = 36
    ...
    defaultConfig {
        applicationId = cytechPackageName
    ...
    sourceSets["main"].java.srcDirs(generatedCytechDir)
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedCytechDir, "$cytechPackageName.info", "InfoDistributor", constantList)
    }
}
