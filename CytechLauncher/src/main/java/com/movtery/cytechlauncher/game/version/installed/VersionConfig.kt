...
import com.movtery.cytechlauncher.game.version.installed.VersionsManager.getCytechVersionPath
...
import com.movtery.cytechlauncher.utils.string.getStringNotNull
import java.io.File
...
class VersionConfig(
    ...
    fun saveWithThrowable() {
        val cytechVersionPath = getCytechVersionPath(versionPath)
        val configFile = File(cytechVersionPath, "version.config")
        if (!cytechVersionPath.exists()) cytechVersionPath.mkdirs()
    ...
    companion object CREATOR : Parcelable.Creator<VersionConfig> {
        ...
        fun parseConfig(versionPath: File): VersionConfig {
            val configFile = File(getCytechVersionPath(versionPath), "version.config")
