...
import com.movtery.cytechlauncher.game.download.game.parseLibraryComponents
...
import com.movtery.cytechlauncher.game.plugin.renderer.RendererPluginManager
import com.movtery.cytechlauncher.game.renderer.Renderers
import com.movtery.cytechlauncher.game.support.touch_controller.ControllerProxy
...
import com.movtery.cytechlauncher.utils.file.ensureDirectorySilently
...
import com.movtery.cytechlauncher.utils.string.isBiggerTo
import com.movtery.cytechlauncher.utils.string.isEqualTo
...
class GameLauncher(
    ...
    private fun printLauncherInfo(
        ...
        append("Info: Architecture: ${Architecture.archAsString(CytechApplication.DEVICE_ARCHITECTURE)}")
