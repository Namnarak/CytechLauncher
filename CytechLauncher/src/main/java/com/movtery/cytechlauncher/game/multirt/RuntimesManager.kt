...
package com.movtery.cytechlauncher.game.multirt
...
import com.movtery.cytechlauncher.utils.math.findNearestPositive
import com.movtery.cytechlauncher.utils.string.compareVersion
import com.movtery.cytechlauncher.utils.string.extractUntilCharacter
...
object RuntimesManager {
    ...
    suspend fun downloadAndInstallRuntime(
        ...
        try {
            ...
            val response = com.movtery.cytechlauncher.path.GLOBAL_CLIENT.get(url)
