...
package com.movtery.cytechlauncher.game.download.game
...
import com.movtery.cytechlauncher.context.GlobalContext
import com.movtery.cytechlauncher.coroutine.Task
import com.movtery.cytechlauncher.coroutine.TaskFlowExecutor
import com.movtery.cytechlauncher.coroutine.TitledTask
import com.movtery.cytechlauncher.coroutine.addTask
import com.movtery.cytechlauncher.coroutine.buildPhase
import com.movtery.cytechlauncher.game.addons.mirror.mapBMCLMirrorUrls
import com.movtery.cytechlauncher.game.addons.modloader.ModLoader
import com.movtery.cytechlauncher.game.addons.modloader.cleanroom.CleanroomVersion
import com.movtery.cytechlauncher.game.addons.modloader.fabriclike.FabricLikeVersion
import com.movtery.cytechlauncher.game.addons.modloader.forgelike.ForgeLikeVersion
import com.movtery.cytechlauncher.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.movtery.cytechlauncher.game.addons.modloader.modlike.ModVersion
import com.movtery.cytechlauncher.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.movtery.cytechlauncher.game.download.game.cleanroom.getCleanroomDownloadTask
import com.movtery.cytechlauncher.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.movtery.cytechlauncher.game.download.game.fabric.getFabricLikeCompleterTask
import com.movtery.cytechlauncher.game.download.game.fabric.getFabricLikeDownloadTask
import com.movtery.cytechlauncher.game.download.game.forge.getForgeLikeAnalyseTask
import com.movtery.cytechlauncher.game.download.game.forge.getForgeLikeDownloadTask
import com.movtery.cytechlauncher.game.download.game.forge.getForgeLikeInstallTask
import com.movtery.cytechlauncher.game.download.game.forge.isNeoForge
import com.movtery.cytechlauncher.game.download.game.forge.targetTempForgeLikeInstaller
import com.movtery.cytechlauncher.game.download.game.optifine.getOptiFineDownloadTask
import com.movtery.cytechlauncher.game.download.game.optifine.getOptiFineInstallTask
import com.movtery.cytechlauncher.game.download.game.optifine.getOptiFineModsDownloadTask
import com.movtery.cytechlauncher.game.download.game.optifine.targetTempOptiFineInstaller
import com.movtery.cytechlauncher.game.download.jvm_server.JVMSocketServer
import com.movtery.cytechlauncher.game.download.jvm_server.JvmService
import com.movtery.cytechlauncher.game.path.getGameHome
import com.movtery.cytechlauncher.game.version.download.BaseMinecraftDownloader
import com.movtery.cytechlauncher.game.version.download.MinecraftDownloader
import com.movtery.cytechlauncher.game.version.installed.VersionConfig
import com.movtery.cytechlauncher.game.version.installed.VersionFolders
import com.movtery.cytechlauncher.game.version.installed.VersionsManager
import com.movtery.cytechlauncher.path.PathManager
import com.movtery.cytechlauncher.utils.file.copyDirectoryContents
import com.movtery.cytechlauncher.utils.logging.Logger.lDebug
import com.movtery.cytechlauncher.utils.logging.Logger.lError
import com.movtery.cytechlauncher.utils.logging.Logger.lInfo
import com.movtery.cytechlauncher.utils.logging.Logger.lWarning
import com.movtery.cytechlauncher.utils.network.downloadFromMirrorListSuspend
