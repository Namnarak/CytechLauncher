...
package com.movtery.cytechlauncher.game.plugin.renderer

import android.content.Context
import android.content.pm.ApplicationInfo
import com.movtery.cytechlauncher.R
import com.movtery.cytechlauncher.game.plugin.ApkPlugin
import com.movtery.cytechlauncher.game.plugin.ApkPluginManager
import com.movtery.cytechlauncher.game.plugin.cacheAppIcon
import com.movtery.cytechlauncher.game.renderer.Renderers

/**
 * FCL、CytechLauncher 渲染器插件，同时支持使用本地渲染器插件
    ...
    override fun parseApkPlugin(
        ...
        if (info.flags and ApplicationInfo.FLAG_SYSTEM == 0) {
            ...
            if (
                ...
                metaData.getBoolean("cytechRendererPlugin", false)
            ) {
