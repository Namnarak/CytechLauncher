...
package com.movtery.cytechlauncher
...
import com.movtery.cytechlauncher.context.refreshContext
...
import com.movtery.cytechlauncher.setting.loadAllSettings
import com.movtery.cytechlauncher.ui.activities.showFatalError
import com.movtery.cytechlauncher.ui.activities.showLauncherCrash
...
import com.movtery.cytechlauncher.utils.writeCrashFile
...
@HiltAndroidApp
class CytechApplication : Application(), SingletonImageLoader.Factory {
    companion object {
        @JvmStatic
    ...
    override fun onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler { _, th ->
            ...
            showLauncherCrash(this@CytechApplication, throwable, th !is SplashException)
        ...
        runCatching {
            ...
            writeCrashFile(
                ...
                Log.w("CytechApplication", "An exception occurred while saving the crash report", it)
            }
