...
JNIEXPORT void JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jint JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
