...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    if (dalvikJavaVMPtr == NULL) {
        ...
        class_CytechInvoker = (*env)->NewGlobalRef(env,(*env)->FindClass(env, "com/movtery/cytechlauncher/bridge/CytechNativeInvoker"));
        method_OpenLink= (*env)->GetStaticMethodID(env, class_CytechInvoker, "openLink", "(Ljava/lang/String;)V");
        method_OpenPath= (*env)->GetStaticMethodID(env, class_CytechInvoker, "openLink", "(Ljava/lang/String;)V");
        method_QuerySystemClipboard = (*env)->GetStaticMethodID(env, class_CytechInvoker, "querySystemClipboard", "()V");
        method_PutClipboardData = (*env)->GetStaticMethodID(env, class_CytechInvoker, "putClipboardData", "(Ljava/lang/String;Ljava/lang/String;)V");
...
JNIEXPORT void JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_sendInputData(JNIEnv* env, jclass clazz, jint type, jint i1, jint i2, jint i3, jint i4) {
...
JNIEXPORT jintArray JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_renderAWTScreenFrame(JNIEnv* env, jclass clazz /*, jobject canvas, jint width, jint height */) {
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCClipboard_nQuerySystemClipboard(JNIEnv *env, jclass clazz) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_CytechInvoker, method_QuerySystemClipboard);
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCClipboard_nPutClipboardData(JNIEnv* env, jclass clazz, jstring clipboardData, jstring clipboardDataMime) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_CytechInvoker, method_PutClipboardData,
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCDesktopPeer_openFile(JNIEnv *env, jclass clazz, jstring filePath) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_CytechInvoker, method_OpenPath, (*dalvikEnv)->NewStringUTF(dalvikEnv, stringChars));
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCDesktopPeer_openUri(JNIEnv *env, jclass clazz, jstring uri) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_CytechInvoker, method_OpenLink, (*dalvikEnv)->NewStringUTF(dalvikEnv, stringChars));
    (*env)->ReleaseStringUTFChars(env, uri, stringChars);
    if(detachable) (*dalvikJavaVMPtr)->DetachCurrentThread(dalvikJavaVMPtr);
}

JNIEXPORT void JNICALL Java_com_movtery_cytechlauncher_bridge_CytechBridge_clipboardReceived(JNIEnv *env, jclass clazz, jstring clipboardData, jstring clipboardDataMime) {
...
Java_com_movtery_cytechlauncher_bridge_CytechBridge_moveWindow(JNIEnv *env, jclass clazz, jint xoff, jint yoff) {
    if (runtimeJNIEnvPtr_INPUT == NULL) {
        if (runtimeJavaVMPtr == NULL) {
            return;
        } else {
